...
if (!address) {
  return (
    <div className="landing">
      <h1>Welcome to GreensDAO</h1>
      <h2>Join to earn $GREEN tokens</h2>
      <p>Let's build a community of healthy eaters who want to grow their own greens!</p>
...
// If the user has already claimed their NFT we want to display the interal DAO page to them
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free GreensDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => {
          setIsClaiming(true);
